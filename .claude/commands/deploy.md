---
description: Safe application deployment with rollback
---
...
@include shared/recovery-state-patterns.yml#Automatic_Triggers
...
**Recovery Command:** `/deploy --rollback <checkpoint-id>`
...
Action: "❌ DEPLOYMENT BLOCKED: Secrets detected in code"
```
